...
export function createApp(deps: AppDeps): FastifyInstance {
  ...
  // --- Signing in. Cloudflare Access below; see core/cloudflare-access.ts for why the signed
  // assertion is the only thing trusted, never the companion e-mail header.
